...
const App = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <div id="home" className="w-full h-[100vh] flex justify-between px-[6rem] items-center text-red-300">
      ...
      {/* Products Section */}
      <div id="products" className="w-full p-[4rem] bg-red-300 flex flex-col gap-1 justify-center items-center">
        {/* Row with 3 div */}
        <div className="flex gap-1">
          <div className="bg-white h-[40vh] w-[20vw]"></div>
          <div className="bg-white h-[40vh] w-[20vw]"></div>
          <div className="bg-white h-[40vh] w-[20vw]"></div>
        </div>
        ...
        {/* Row with 2 div */}
        <div className="flex gap-1">
          <div className="bg-white h-[40vh] w-[30vw]"></div>
          <div className="bg-white h-[40vh] w-[30vw]"></div>
        </div>
      </div>

      {/* About Us */}
      <div id="about" className="w-full h-auto p-[5rem] flex items-center justify-between">
        {/*  */}
      ...
      <div id="testimonials">
        ...
        <marquee scrollAmount={50} className="flex">
          Reviews
        </marquee>
        <hr className="text-red-100" />
      </div>
      ...
      {/* Newsletter */}
      <div id="newsletters" className="flex flex-col py-[10rem] justify-center items-center gap-2">
